""" Este programa tiene como funcionalidad verificar que se está ingresando correctamente texto sin caracteres
especiales, ni números.
Éste tipo de pruebas nos ayudan a evitar posibles errores en el programa, detectar errores en el código interno
(obviamente, si tenemos acceso a él), mayormente son utilizadas por hackers ya que al no tener acceso al código,
realizan pruebas de inyección. """
...
label2 = Label(root,justify="left",text="Prueba de caja negra", bg="#263844",font=("Sitka",10),fg="white").pack(anchor="sw",side="bottom",fill="both",expand=1)
